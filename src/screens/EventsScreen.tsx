...
const styles = StyleSheet.create({
  ...
  eventTitle: { fontFamily: fonts.sans, fontSize: 18, fontWeight: '600', color: colors.text, letterSpacing: -0.2, lineHeight: 24, flex: 1 },
  ...
  eventDesc: { fontSize: 14, color: colors.textMuted, lineHeight: 20, marginBottom: 4 },
  ...
  emptyTitle: {
    fontFamily: fonts.sans, fontSize: 18, fontWeight: '600', color: colors.text,
    letterSpacing: -0.1,
  },
  emptySubtitle: {
