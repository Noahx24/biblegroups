...
const styles = StyleSheet.create({
  ...
  sectionLabel: { fontSize: 12, fontWeight: '600', letterSpacing: 0.8, color: colors.textMuted, textTransform: 'uppercase', paddingHorizontal: spacing.lg, paddingTop: 18, paddingBottom: 8 },
  ...
  childAvatarText: { fontFamily: fonts.sans, fontSize: 20, fontWeight: '700', color: '#fff' },
  childInfo: { flex: 1 },
  childName: { fontFamily: fonts.sans, fontSize: 18, fontWeight: '600', color: colors.text, letterSpacing: -0.2 },
  ...
  programName: { fontFamily: fonts.sans, fontSize: 18, fontWeight: '600', color: colors.text, letterSpacing: -0.2, flex: 1 },
  ...
  sectionDividerText: { fontSize: 12, fontWeight: '600', letterSpacing: 0.8, color: colors.textMuted, textTransform: 'uppercase' },
  consentBox: {
