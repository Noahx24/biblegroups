...
const styles = StyleSheet.create({
  ...
  cardTitle: { fontFamily: fonts.sans, fontSize: 18, fontWeight: '600', color: colors.text, letterSpacing: -0.2, flex: 1, lineHeight: 24 },
  deleteBtn: { fontSize: 14, color: colors.textMuted, paddingHorizontal: 4 },
  cardBody2: { fontSize: 16, color: colors.textSoft, lineHeight: 24, marginTop: 6 },
  ...
  input: { borderWidth: 1, borderColor: colors.border, borderRadius: radius.md, padding: spacing.md, fontSize: 16, color: colors.text, backgroundColor: colors.surface },
