...
const styles = StyleSheet.create({
  ...
  cardLabel: { fontSize: 12, fontWeight: '600', letterSpacing: 0.8, color: colors.textMuted, textTransform: 'uppercase', marginBottom: 10 },
  ...
  verseRef: { fontFamily: fonts.sans, fontSize: 22, fontWeight: '700', color: colors.primary, letterSpacing: -0.2, marginBottom: 10 },
  verseText: { fontFamily: fonts.sans, fontSize: 18, lineHeight: 27, color: colors.textSoft },
  ...
  leaderMeta: { flex: 1 },
  leaderName: { fontFamily: fonts.sans, fontSize: 22, fontWeight: '600', color: colors.text, letterSpacing: -0.2, lineHeight: 26 },
  ...
  themeBoxLabel: { fontSize: 12, fontWeight: '600', letterSpacing: 0.8, color: colors.textMuted, textTransform: 'uppercase', marginBottom: 4 },
  themeBoxText: { fontFamily: fonts.sans, fontSize: 16, color: colors.textSoft, lineHeight: 23 },
  noLeaderTitle: { fontFamily: fonts.sans, fontSize: 18, fontWeight: '600', color: colors.textMuted, letterSpacing: -0.1, marginBottom: 2 },
  ...
  planDayNum: { fontFamily: fonts.sans, fontSize: 14, fontWeight: '700', lineHeight: 18, color: colors.textSoft },
  planDayNumActive: { color: '#fff' },
  planMeta: { flex: 1, minWidth: 0 },
  planRef: { fontFamily: fonts.sans, fontSize: 14.5, fontWeight: '700', color: colors.text, letterSpacing: -0.1 },
  ...
  avatarText: { color: '#fff', fontFamily: fonts.sans, fontWeight: '600', letterSpacing: 0.5 },
  primaryBtn: {
  ...
  translationLabel: { fontSize: 12, fontWeight: '600', letterSpacing: 0.8, color: colors.textMuted, textTransform: 'uppercase' },
  ...
  modalDate: { fontFamily: fonts.sans, fontSize: 18, fontWeight: '600', color: colors.text, marginBottom: spacing.sm },
  modalFieldLabel: { fontSize: 12, fontWeight: '600', letterSpacing: 0.8, color: colors.textMuted, textTransform: 'uppercase', marginTop: spacing.sm },
