...
const styles = StyleSheet.create({
  ...
  initialsAvatarText: { color: '#fff', fontFamily: fonts.sans, fontWeight: '600', letterSpacing: 0.5 },
  identityName: { fontFamily: fonts.sans, fontSize: 20, fontWeight: '600', color: colors.text, letterSpacing: -0.2 },
  ...
  fieldLabel: { fontSize: 12, fontWeight: '600', letterSpacing: 0.8, color: colors.textMuted, textTransform: 'uppercase' },
  fieldInput: { backgroundColor: colors.background, borderWidth: 1, borderColor: colors.border, borderRadius: radius.md, padding: 11, paddingHorizontal: 13, fontSize: 16, color: colors.text, fontWeight: '500' },
  fieldTextarea: { minHeight: 80, textAlignVertical: 'top', fontFamily: fonts.sans, fontSize: 16, lineHeight: 24, color: colors.textSoft },
