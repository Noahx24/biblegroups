...
const styles = StyleSheet.create({
  ...
  identityName: { fontFamily: fonts.serif, fontSize: 22, fontWeight: '600', color: colors.text, letterSpacing: -0.2 },
  ...
  fieldInput: {
    ...
    borderRadius: radius.md, padding: 11, paddingHorizontal: 13,
    fontSize: 15.5, color: colors.text, fontWeight: '500',
  },
  ...
  saveBtn: {
    ...
    paddingHorizontal: 18, alignItems: 'center', marginTop: 14,
